...
class HyperCube():
    ...
    def convert_bil_to_array(self, raw_bil_file):
        ...
        # Read in each spectral band, (there are 300 bands)
    ...
    def fix_image(self, correction_file):
        """
        Perform darkness correction and reflectance calibration.
        """

        self.image = self.dark_correction(correction_file)
